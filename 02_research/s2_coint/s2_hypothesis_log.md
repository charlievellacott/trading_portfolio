...
| ----- | ---------- | ----- | ----------------------------------------------- | ------------- | ------------------------------------------- |
| H-001 | 2026-08-10 | Coint | Universes A–F                                   | —             | DECIDED: C = Shelved D = Shelved |
...
| H-004 | 2026-08-23 | Coint | Book construction: frozen vs quarterly rotating | —             | DECIDED: freeze                             |
| H-005 | 2026-08-23 | Coint | Window screens (OLS / ADF / entry z / z)        | —             | DECIDED: ols252 / adf252 / ez1.5 / z90      |
| H-006 | 2026-08-10 | Coint | Kalman β vs static OLS hedge (trad z)           | —             | DECIDED: ols                                |
| H-007 | 2026-08-10 | Coint | ADX and/or RSI trend filter                     | —             | DECIDED: off                                |
| H-008 | 2026-08-10 | Coint | Half-life gate (trad z)                         | —             | DECIDED: off                                |
| H-009 | 2026-08-10 | Coint | Overlapping legs: allow vs never-allow          | —             | DECIDED: never_allow                        |
| H-010 | 2026-08-10 | Coint | Exit: ATR stop (+ breaker) then HL time-stop  | —             | OPEN — sequential ATR→HL                    |
| H-011 | 2026-08-10 | Coint | Kalman spread-correlation gate                  | —             | DECIDED: off                                |
| H-012 | 2026-08-10 | Coint | Score × confidence sizing                       | —             | DECIDED: score                              |
| H-013 | 2026-08-10 | Coint | Vol-aware entry k_t vs S1 vol targeting         | —             | DECIDED: s1_vt                              |
| H-014 | 2026-08-12 | Coint | Adaptive z-window (trad z)                      | —             | DECIDED: fixed                              |
| H-015 | 2026-08-10 | Coint | Entry extremity scores                          | —             | DECIDED: trad_z                             |
...
| Field                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Status**             | DECIDED: C = Shelved D = Shelved                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **What it is**         | Compare candidate pair universes **A–F** under the same trading rules. A (FX), B (crypto), C (Asia EM), D (US share-class twins) are re-run for the record only; **E** (US REIT sub-sectors) and **F** (EUR large caps) compete for `UNIVERSE_STAR`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Hypothesis**         | At least one of E / F delivers positive net Sharpe after costs with low or negative correlation to S1.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
**Universe C shelved (2026-08).** Gross Sharpe ≈ 0 (+0.02 to +0.24) before costs, net −0.08 to −0.48 after. Cost drag 271–439 bps/yr (HK 116 bps/RT, JP 64 bps/RT); median rolling ADF p 0.19–0.30, significant only 11–29% of days. Not a timing bug and not a trade-frequency problem (~3.6–4.2 round-trips/yr, `|z|>2` on ~12% of days). Per-pair table lives in `02_research/s2_coint/universe.md`; archived Asia artifacts in `04_backtest/s2_coint/artifacts/asia_c/`. See Universe D shelved note below.

**Universe D shelved (2026-09).** WSO.B is not shortable via Alpaca or Interactive Brokers (IBKR). Locked book was `WSO.B|WSO`, `NWS|NWSA`, `HEI|HEI.A`; `WSO|WSO.B` delivered the entirety of the returns. No further broker search. H-001 drops US tickers with Alpaca `shortable=False` before EG screening (`easy_to_borrow` is display-only). A / B / C / D stay documented as learning points and are not re-selected.
...
| Field                  |                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Status**             | DECIDED: block_05_flat_10                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| Field                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Status**             | DECIDED: ols252 / adf252 / ez1.5 / z90                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
## H-010 · Coint · Exit: ATR stop (+ breaker) then HL time-stop · 2026-08-10


| Field                  | Content |
| ---------------------- | ------- |
| **Status**             | OPEN — sequential ATR→HL |
| **What it is**         | Orthogonal exits: ATR-on-spread stop at k×ATR sized to fixed 1% portfolio loss + per-pair breaker; separate HL time-stop after n half-lives. |
| **Hypothesis**         | Protective ATR stops (with breaker) and/or an HL time-stop improve Sharpe / max DD / corr to S1 vs mean-exit-only when screened sequentially (ATR first, then HL with ATR frozen). |
| **Economic rationale** | — |
| **Data required**      | — |
| **Test to complete**   | Sequential freeze: (A) ATR multiples {2, 2.5, 3} vs mean_only (HL off); freeze `ATR_EXIT_STAR`. (B) HL on/off (n=3) with ATR frozen; freeze `HL_EXIT_STAR`. Combine only if both screens independently pick their protective arm. Fold-val only; sealed OOS once. |
| **Notes**              | **ATR stop:** entry ± k×ATR; size so stop hit ≈ **1%** book. Trigger on **spread close** at signal `t` (not intrabar H/L); exit fill open `t+1` for live parity. **Breaker:** pair open-PnL floor (default **−10%**, notebook constant) on ATR arms only. **HL exit:** flat after n × half-life. **STARs:** `ATR_EXIT_STAR` (`off`\|k), `HL_EXIT_STAR` (`off`\|`on`), `PAIR_MAX_LOSS_STAR`. |
...
| **Hypothesis**         | k_t = k_0 \cdot \sigma_t / \bar\sigma beats fixed k on Sharpe / max DD / corr to S1; compare in-test to S1 portfolio vol targeting (S1 H-014 / `06_risk/analytics/s1_equities/vol_targeting.py`). |
| **Economic rationale** | —                                                                                                                                                                                       |
| **Data required**      | —                                                                                                                                                                                       |
